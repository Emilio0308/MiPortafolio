...
const About = () => {
  return (
    <section id='about' className='w-full'>
      <section className='max-w-[1024px] grid grid-rows-2 gap-5 p-3 sm:grid-cols-2 sm:grid-rows-[1fr,0] sm:gap-y-0 h-screen sm:h-auto mx-auto'>
        <div className='flex justify-center flex-col gap-5 text-gray-200 sm:border-b-2 border-cyan-500'>
          ...
          <p className='overflow-hidden'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit vitae architecto harum facilis numquam iusto, deserunt repudiandae labore velit, incidunt asperiores veniam maxime natus? Consequuntur quia ab minima nesciunt sapiente.</p>
        </div>
